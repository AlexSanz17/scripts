SELECT * FROM RECURSO where idmodulo = 5
SELECT * FROM RECURSO where codigo = 'UsuFinMnuMisExp';
SELECT * FROM RECURSO where codigo = 'UsuFinBtnBus';

delete from RECURSO where idrecurso = 248;
