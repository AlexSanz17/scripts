--SET IDENTITY_INSERT GRIDCOLUMNA ON;
...
Insert into GRIDCOLUMNA
   (IDGRIDCOLUMNA, FIELD, NAME, NORESIZE, WIDTH, 
    HIDDEN, FORMATER, POSITION)
 Values
   (5, 'fecharecepcion', 'Fecha Recepción', 0, '110px', 
    0, 'formatterDate', 8);
Insert into GRIDCOLUMNA
   (IDGRIDCOLUMNA, FIELD, NAME, NORESIZE, WIDTH, 
    HIDDEN, POSITION)
...
Insert into GRIDCOLUMNA
   (IDGRIDCOLUMNA, FIELD, NAME, NORESIZE, WIDTH, 
    HIDDEN, FORMATER, POSITION)
 Values
   (43, 'fechacreacion', 'Fecha de Creación', 0, '110px', 
    0, 'formatterDate', 32);
Insert into GRIDCOLUMNA
   (IDGRIDCOLUMNA, FIELD, NAME, NORESIZE, WIDTH, 
    HIDDEN, FORMATER, POSITION)
...
Insert into GRIDCOLUMNA
   (IDGRIDCOLUMNA, FIELD, NAME, NORESIZE, WIDTH, 
    HIDDEN, FORMATER, POSITION)
 Values
   (44, 'fechaatender', 'Fecha de Atención', 0, '120px', 
    0, 'formatterDate', 13);
Insert into GRIDCOLUMNA
   (IDGRIDCOLUMNA, FIELD, NAME, NORESIZE, WIDTH, 
    HIDDEN, FORMATER, POSITION)
...
Insert into GRIDCOLUMNA
   (IDGRIDCOLUMNA, FIELD, NAME, NORESIZE, WIDTH, 
    HIDDEN, POSITION)
 Values
   (34, 'area', 'Área Remitente', 0, '150px', 
    0, 34);
Insert into GRIDCOLUMNA
   (IDGRIDCOLUMNA, FIELD, NAME, NORESIZE, WIDTH, 
    HIDDEN, POSITION)
...
Insert into GRIDCOLUMNA
   (IDGRIDCOLUMNA, FIELD, NAME, NORESIZE, WIDTH, 
    HIDDEN, POSITION)
 Values
   (42, 'nroTramite', 'Nro Trámite', 0, '57px', 
    0, 32);
Insert into GRIDCOLUMNA
   (IDGRIDCOLUMNA, FIELD, NAME, NORESIZE, WIDTH, 
    HIDDEN, FORMATER, POSITION)
 Values
   (45, 'fechaanulacion', 'Fecha de Anulación', 0, '150px', 
    0, 'formatterDate', 13);
Insert into GRIDCOLUMNA
   (IDGRIDCOLUMNA, FIELD, NAME, NORESIZE, WIDTH, 
    HIDDEN, FORMATER, POSITION)
...
Insert into GRIDCOLUMNA
   (IDGRIDCOLUMNA, FIELD, NAME, NORESIZE, WIDTH, 
    HIDDEN, POSITION)
 Values
   (55, 'areaAutor', 'Área Autor', 0, '150px', 
    0, 34);
Insert into GRIDCOLUMNA
   (IDGRIDCOLUMNA, FIELD, NAME, NORESIZE, WIDTH, 
    HIDDEN, FORMATER, POSITION)
...
Insert into GRIDCOLUMNA
   (IDGRIDCOLUMNA, FIELD, NAME, NORESIZE, WIDTH, 
    HIDDEN, POSITION)
 Values
   (52, 'nroTramiteVirtual', 'Nro Trámite', 0, '88px', 
    0, 32);
Insert into GRIDCOLUMNA
   (IDGRIDCOLUMNA, FIELD, NAME, NORESIZE, WIDTH, 
    HIDDEN, POSITION)
 Values
   (53, 'nroTramiteEntidad', 'Nro Trámite Virtual', 0, '88px', 
    0, 32);
Insert into GRIDCOLUMNA
   (IDGRIDCOLUMNA, FIELD, NAME, NORESIZE, WIDTH, 
    HIDDEN, POSITION)
