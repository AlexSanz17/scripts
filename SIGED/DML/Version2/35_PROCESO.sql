...
Insert into PROCESO
 ...
 Values
   (2, 1, 1, 1, 'TUPA 02: SOLICITUD DE ACCESO A LA INFORMACION DE EXPEDIENTES EN TRAMITE', 
    'TUPA', 'TUPA 02: SOLICITUD DE ACCESO A LA INFORMACIÓN DE EXPEDIENTES EN TRÁMITE', 10, 'S', GETDATE(), 
    'A', 58, 'N', 'N', 0, 
    '0.6', '0.8', 'S', 'V');
...
Insert into PROCESO
 ...
 Values
   (4, 1, 1, 1, 'TUPA 04: PROCEDIMIENTO DE FIJACIÓN Y REVISION TARIFARIA', 
    'TUPA', 'TUPA 04: PROCEDIMIENTO DE FIJACIÓN Y REVISION TARIFARIA', 10, 'S', GETDATE(), 
    'A', 58, 'N', 'N', 0, 
    '0.6', '0.8', 'S', 'V');
...
Insert into PROCESO
 ...
 Values
   (5, 1, 1, 1, 'TUPA 05: PROCEDIMIENTO DE FIJACIÓN TARIFARIA DE SERVICIOS NUEVOS', 
    'TUPA', 'TUPA 05: PROCEDIMIENTO DE FIJACIÓN TARIFARIA DE SERVICIOS NUEVOS', 10, 'S', GETDATE(), 
    'A', 58, 'N', 'N', 0, 
    '0.6', '0.8', 'S', 'V');
...
Insert into PROCESO
 ...
 Values
   (9, 1, 1, 1, 'TUPA 09: PROCEDIMIENTO DE IMPUGNACIÓN DE RESOLUCIONES QUE IMPONEN SANCIONES', 
    'TUPA', 'TUPA 09: PROCEDIMIENTO DE IMPUGNACIÓN DE RESOLUCIONES QUE IMPONEN SANCIONES', 10, 'S', GETDATE(), 
    'A', 58, 'N', 'N', 0, 
    '0.6', '0.8', 'S', 'V');
Insert into PROCESO
   (IDPROCESO, RESPONSABLE, TIPOPROCESO, IDTIPOACCESO, NOMBRE, 
...
Insert into PROCESO
 ...
 Values
   (13, 1, 1, 1, 'TUPA 13: PROCEDMIENTO DE SOLUCIÓN DE CONTROVERSIAS EN LA EJECUCIÓN DEL CONTRATO DE ACCESO Y DE SOLUCIÓN DE CONTROVERSIAS ENTRE ENTIDADES PRESTADORAS', 
    'TUPA', 'TUPA 13: PROCEDMIENTO DE SOLUCIÓN DE CONTROVERSIAS EN LA EJECUCIÓN DEL CONTRATO DE ACCESO Y DE SOLUCIÓN DE CONTROVERSIAS ENTRE ENTIDADES PRESTADORAS', 10, 'S', GETDATE(), 
    'A', 58, 'N', 'N', 0, 
    '0.6', '0.8', 'S', 'V');
Insert into PROCESO
   (IDPROCESO, RESPONSABLE, TIPOPROCESO, IDTIPOACCESO, NOMBRE, 
 ...
 Values
   (14, 1, 1, 1, 'TUPA 14: PROCEDIMIENTO DE IMPUGNACIÓN DE LA DECISIÓN DE LAS ENTIDADES PRESTADORAS QUE RESUELVEN RECLAMOS DE USUARIOS', 
    'TUPA', 'TUPA 14: PROCEDIMIENTO DE IMPUGNACIÓN DE LA DECISIÓN DE LAS ENTIDADES PRESTADORAS QUE RESUELVEN RECLAMOS DE USUARIOS', 10, 'S', GETDATE(), 
    'A', 58, 'N', 'N', 0, 
    '0.6', '0.8', 'S', 'V');
Insert into PROCESO
   (IDPROCESO, RESPONSABLE, TIPOPROCESO, IDTIPOACCESO, NOMBRE, 
 ...
 Values
   (15, 1, 1, 1, 'TUPA 15: PROCEDIMIENTO DE IMPUGNACIÓN DE LA DENEGATORIA DE SOLICITUD DE MODIFICACIÓN DE LA INFRAESTRUCTURA, DENEGATORIA DE LA SOLICITUD DE ACCESO, DETERMINACIÓN DEL MECANISMO DE ASIGNACIÓN DE LA FACIL', 
    'TUPA', 'TUPA 15: PROCEDIMIENTO DE IMPUGNACIÓN DE LA DENEGATORIA DE SOLICITUD DE MODIFICACIÓN DE LA INFRAESTRUCTURA, DENEGATORIA DE LA SOLICITUD DE ACCESO, DETERMINACIÓN DEL MECANISMO DE ASIGNACIÓN DE LA FACIL', 10, 'S', GETDATE(), 
    'A', 58, 'N', 'N', 0, 
    '0.6', '0.8', 'S', 'V');
Insert into PROCESO
   (IDPROCESO, RESPONSABLE, TIPOPROCESO, IDTIPOACCESO, NOMBRE, 
